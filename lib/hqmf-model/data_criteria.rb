module HQMF
  ...
  class DataCriteria
    ...
    FIELDS = {'SEVERITY' => {title:'Severity', coded_entry_method: :severity, code: 'SEV', code_system:'2.16.840.1.113883.5.4', template_id: '2.16.840.1.113883.3.560.1.1021.2', field_type: :value},
             ...
             'FACILITY_LOCATION_ARRIVAL_DATETIME' => {title:'Facility Location Arrival Date/Time', coded_entry_method: :facility, code: 'SDLOC_ARRIVAL', field_type: :nested_timestamp},
             'FACILITY_LOCATION_DEPARTURE_DATETIME' => {title:'Facility Location Departure Date/Time', coded_entry_method: :facility, code: 'SDLOC_DEPARTURE', field_type: :nested_timestamp},
