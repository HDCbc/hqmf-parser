module HQMF
  ...
  class DataCriteria
    ...
    FIELDS = {'SEVERITY'=>{title:'Severity',coded_entry_method: :severity, code: 'SEV', codeSystem:'2.16.840.1.113883.5.4', templateId: '2.16.840.1.113883.3.560.1.1021.2'},
             'ORDINAL'=>{title:'Ordinal',coded_entry_method: :ordinal, code: '117363000', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1012.2'},
             'REASON'=>{title:'Reason',coded_entry_method: :reason, code: '410666004', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1017.2'},
             'SOURCE'=>{title:'Source',coded_entry_method: :source, code: '260753009', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.2001.2'},
             'CUMULATIVE_MEDICATION_DURATION'=>{title:'Cumulative Medication Duration',coded_entry_method: :cumulative_medication_duration, code: '363819003', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1001.3'},
             ...
             'DISCHARGE_DATETIME'=>{title:'Discharge Date/Time',coded_entry_method: :discharge_datetime, code: '442864001', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1025.1'},
             'DISCHARGE_STATUS'=>{title:'Discharge Status',coded_entry_method: :discharge_status, code: '309039003', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1003.2'},
             ...
             'LENGTH_OF_STAY'=>{title:'Length of Stay',coded_entry_method: :length_of_stay, code: '183797002', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1029.3'},
             'DOSE'=>{title:'Dose',coded_entry_method: :dose, code: '398232005', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1004.1'},
             'ROUTE'=>{title:'Route',coded_entry_method: :route, code: '263513008', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1020.2'},
             'START_DATETIME'=>{title:'Start Date/Time',coded_entry_method: :start_datetime, code: '398201009', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1027.1'},
             'FREQUENCY'=>{title:'Frequency',coded_entry_method: :frequency, code: '260864003', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1006.1'},
             'ANATOMICAL_STRUCTURE'=>{title:'Anatomical Structure',coded_entry_method: :anatomical_structure, code: '91723000', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1000.2'},
             'STOP_DATETIME'=>{title:'Stop Date/Time',coded_entry_method: :stop_datetime, code: '397898000', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1026.1'},
             'INCISION_DATETIME'=>{title:'Incision Date/Time',coded_entry_method: :incision_datetime, code: '34896006', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1007.1'},
             'REMOVAL_DATETIME'=>{title:'Removal Date/Time',coded_entry_method: :removal_datetime, code: '118292001 (qualified by 118575009)', codeSystem:'2.16.840.1.113883.6.96', templateId: '2.16.840.1.113883.3.560.1.1032.1'}
             }
